...
const (
	ChatRoom_Join_FullMethodName     = "/ChatRoom/Join"
	ChatRoom_Send_FullMethodName     = "/ChatRoom/Send"
	ChatRoom_Register_FullMethodName = "/ChatRoom/Register"
	ChatRoom_Login_FullMethodName    = "/ChatRoom/login"
	ChatRoom_Chat_FullMethodName     = "/ChatRoom/chat"
)
...
type ChatRoomClient interface {
	...
	// 注册client
	Register(ctx context.Context, opts ...grpc.CallOption) (ChatRoom_RegisterClient, error)
	Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrappers.StringValue, error)
...
func (c *chatRoomClient) Join(ctx context.Context, opts ...grpc.CallOption) (ChatRoom_JoinClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatRoom_ServiceDesc.Streams[0], ChatRoom_Join_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *chatRoomJoinClient) Send(m *ChatMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatRoomJoinClient) Recv() (*ChatMessage, error) {
	m := new(ChatMessage)
...
func (c *chatRoomClient) Send(ctx context.Context, in *ChatMessage, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, ChatRoom_Send_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatRoomClient) Register(ctx context.Context, opts ...grpc.CallOption) (ChatRoom_RegisterClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChatRoom_ServiceDesc.Streams[1], ChatRoom_Register_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &chatRoomRegisterClient{stream}
	return x, nil
}

type ChatRoom_RegisterClient interface {
	Send(*ChatMessage) error
	Recv() (*ChatMessage, error)
	grpc.ClientStream
}

type chatRoomRegisterClient struct {
	grpc.ClientStream
}

func (x *chatRoomRegisterClient) Send(m *ChatMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatRoomRegisterClient) Recv() (*ChatMessage, error) {
	m := new(ChatMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *chatRoomClient) Login(ctx context.Context, in *User, opts ...grpc.CallOption) (*wrappers.StringValue, error) {
...
type ChatRoomServer interface {
	...
	// 注册client
	Register(ChatRoom_RegisterServer) error
	Login(context.Context, *User) (*wrappers.StringValue, error)
...
func (UnimplementedChatRoomServer) Send(context.Context, *ChatMessage) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Send not implemented")
}
func (UnimplementedChatRoomServer) Register(ChatRoom_RegisterServer) error {
	return status.Errorf(codes.Unimplemented, "method Register not implemented")
}
func (UnimplementedChatRoomServer) Login(context.Context, *User) (*wrappers.StringValue, error) {
...
func (x *chatRoomJoinServer) Send(m *ChatMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatRoomJoinServer) Recv() (*ChatMessage, error) {
	m := new(ChatMessage)
...
func _ChatRoom_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatRoom_Send_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatRoomServer).Send(ctx, req.(*ChatMessage))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChatRoom_Register_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChatRoomServer).Register(&chatRoomRegisterServer{stream})
}

type ChatRoom_RegisterServer interface {
	Send(*ChatMessage) error
	Recv() (*ChatMessage, error)
	grpc.ServerStream
}

type chatRoomRegisterServer struct {
	grpc.ServerStream
}

func (x *chatRoomRegisterServer) Send(m *ChatMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatRoomRegisterServer) Recv() (*ChatMessage, error) {
	m := new(ChatMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
